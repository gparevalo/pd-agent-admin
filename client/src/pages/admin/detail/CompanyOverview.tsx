...
import PipelineStepsChecklist from "./components/PipelineStepsChecklist";
...
export default function CompanyOverview({
    ...
    const isNewLead = client360?.pipeline_status === "new_lead";

    return (

        <div className="space-y-6">

            {!isNewLead && (<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2">
                    <PipelineTimeline operationId={client360?.operation_id} />
                </div>
                <div className="lg:col-span-1">
                    <PipelineStepsChecklist
                        operationId={client360?.operation_id}
                        currentStage={client360?.pipeline_status || "new_lead"}
                    />
                </div>
            </div>)}
